            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" class="get_btn " href="connecter.html" role="button ">Login</a>
                        </li>
                        <h3> | </h3>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" class="get_btn " href="signup.html" role="button ">Sign Up</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="h-100 w-100" src="3.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img class="h-300 w-100" src="8.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-block">
                ...
                <div class="carousel-item">
                    <img class="h-100 w-100" src="7.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-block">
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row pt-5">
                        <div class="col-md-5 align-items-stretch">
                            <img class="img" src="44.jpg" style="width: 480px ">
